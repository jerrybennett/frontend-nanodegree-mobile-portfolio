...
var resizePizzas = function(size) {
  ...
  // This was changed per Cameron's recommendation in the classroom lesson
  // The old code was too complex for what needs to be done on changePizzaSizes
  // This new code prevents forced synchronous layout
  function changePizzaSizes(size) {
    ...
    // "randomPizza" was created to keep the code DRY and it only queries the DOM once
    var randomPizza = document.getElementsByClassName("randomPizzaContainer");
    // This sets the width by percent from switch statement above
...
function updatePositions() {
  ...
  // Changing the way to access "mover" to "document.getElementsByClassName" instead of "querySelectorAll"
  // increases performance
  var items = document.getElementsByClassName('mover');
  // Caching "document.body.scrollTop" calculation outside of function helps prevent layout thrashing
  // in the for loop and greatly increases performance of function
